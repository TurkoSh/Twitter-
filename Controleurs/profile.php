...
if (strlen($message) > 140) {
    header("Location: ../Vue/Profile/profile.php?error=message_too_long");
}
...
if ($result) {
    header("Location: ../Vue/Profile/profile.php?success=tweet_posted");
} else {
    header("Location: ../Vue/Profile/profile.php?error=failed_to_post_tweet");
}
