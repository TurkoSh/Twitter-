...
$sql = "SELECT tweets.id, tweets.message, tweets.date, user.username, user.avatar FROM tweets INNER JOIN user ON tweets.id_user = user.id ORDER BY tweets.date DESC";
...
<head>
	<meta charset="UTF-8">
	<title>Home</title>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.0/css/all.min.css" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/a0F3ik5zE3SUU3Q0Uq6Q/7l6f8Z2s7EGfkc9J/" crossorigin="anonymous">
	...
	<main class="container">
		...
		<aside class="left-side">
			<nav class="left-navbar">
				<div>
					...
					<div>
						<a href="../../Vue/Profile/profile.php">
							<div>
								<svg viewBox="0 0 24 24">
									<g>
					...
					<div>
						<a href="../../Modele/User/deconnexion.php">
							<div>
								<svg viewBox="0 0 24 24">
									<g>
										<path d="M17.5 12.5h-11a1 1 0 0 1 0-2h11a1 1 0 0 1 0 2zm-3.5 3.5l1.5-1.5h-9a1 1 0 0 1 0-2h9l-1.5-1.5 1-1 4 4-4 4-1-1z"></path>
										<path d="M14 19h-7.5a3.5 3.5 0 0 1-3.5-3.5V8.5A3.5 3.5 0 0 1 6.5 5H14v2H6.5a1.5 1.5 0 0 0-1.5 1.5v7a1.5 1.5 0 0 0 1.5 1.5H14v2z"></path>
									</g>
								</svg>
								<span>Logout</span>
							</div>
				...
				<div class="profile-btn">
					<div class="left-column">
						<img class="profile-image" src="../../IMAGES/pdp.jpg">
					</div>
					<div class="right-column">
						<div>
							<strong>
								...
								<svg viewBox="0 0 24 24" aria-label="Korumal hesap">
								</svg>
							</strong>
							<span class="tag">
								<?php
		...
		<section class="content">
			...
			<div class="tweet">
				...
				<div class="right-column">
					<form class="top-row" action="../../Modele/Tweet/Tweet.php" method="post" enctype="multipart/form-data">
						<input name="message" placeholder="What's happening ?" required>
						<img id="preview-image" src="#" alt="" style="width:100%; border-radius:25px; border:1px solid var(--border-color); margin-top:10px; display:none;">
						...
						<div class="bottom-row">
							...
							<!-- Tweet Button -->
							<button class="tweet-btn" data-toggle="modal" data-target="#tweetModal">Tweet</button>
						</div>
				</div>
				</form>
			</div>
			...
			<script>
				document.getElementById('pictureFileIcon').addEventListener('click', function() {
			...
			if ($result->num_rows > 0) {
				while ($row = $result->fetch_assoc()) {
					...
					echo '<img class="profile-image" src="../../IMAGES/pdp.jpg">';
					echo '</div>';
					echo '<div class="right-column">';
					echo '<article class="top-row">';
					echo '<header class="post-header">';
					echo '<div>';
					echo '<strong><span>' . $_SESSION["name"] . '</span></strong>';
					echo "<span class='tag'>@" . $_SESSION["username"] . "</span>";
					...
					if (!empty($row["image"])) {
						echo '<img class="tweet-image" src="../../Modele/Tweet/uploads/' . $row["image"] . '" alt="Tweet image" style="width:100%; border-radius:25px; border:1px solid var(--border-color); margin-top:10px;">';
					}
				...
				<div class="right-column">
					<article class="top-row">
						<header class="post-header">
							<div>
								<strong>
									<span>Turko Shakhidov</span>
								</strong>
								<span class="tag">@Turko_sh</span>
								<span class="dot">.</span>
								<span class="time">9s</span>
							</div>
							<div class="details">
								<svg viewBox="0 0 24 24" aria-hidden="true">
									<g>
						...
						<p>My Tweet</p>
						<img src="https://www.ilkkimbuldu.com/wp-content/uploads/2017/01/twitter.jpg" alt="github-logo" style="width:100%; border-radius:25px; border:1px solid var(--border-color); margin-top:10px;">
					</article>
					<div class="bottom-row">
						<!-- Comment Button -->
						<div>
		...
		<aside class="right-side">
			<div class="search-bar">
				<form action="../../Controleurs/search_users.php" method="GET">
					<svg viewBox="0 0 24 24" aria-hidden="true">
						<g>
					...
					<input class="search" placeholder="Search Twitter" name="srch-term" id="srch-term">
			...
			<div class="trends">
				...
				<div class="trends-items">
					...
					<div class="trends-item">
						...
						<strong class="hashtag">#BMW>Mercedes</strong>
					...
					<div class="trends-item">
						...
						<strong class="hashtag">#Ganemeilleurafifa</strong>
					...
					<div class="trends-item">
						...
						<strong class="hashtag">#Hamza-est-trop-guez-au-baby</strong>
					...
					<div class="trends-item">
						...
						<strong class="hashtag">#Carrefour-c'est-trop-cher</strong>
					...
					<div class="trends-item">
						...
						<strong class="hashtag">#c'estquoiiiii</strong>
			...
			<div class="who-to-follow">
				...
				<div class="users">
					<!-- User Item Start -->
					<div class="user">
						<img class="profile-image" src="http://images3.memedroid.com/images/UPLOADED730/635435c515fa2.jpeg">
						<div>
							<div>
								<strong class="user-name">Jeremy vas comprendre </strong>
								<span class="tag">@jejestephen</span>
							</div>
					...
					<!-- User Item Start -->
					<div class="user">
						<img class="profile-image" src="https://a.pinatafarm.com/400x400/934cd7999a/lord-farquaad-6359d6affd17bad8cda21f1960b2c176-meme.jpeg">
						<div>
							<div>
								<strong class="user-name">AmineAimeTropLeLait</strong>
								<span class="tag">@Amin_arji</span>
							</div>
							<button class="follow-btn">Follow</button>
						</div>
					</div>
					...
					<!-- User Item Start -->
					<div class="user">
						<img class="profile-image" src="https://a.pinatafarm.com/400x400/25e85b97cf/quandale-dingle.jpg">
						<div>
							<div>
								<strong class="user-name">Ruben il est où ?</strong>
								<span class="tag">@ruben_ribeiro</span>
							</div>
							<button class="follow-btn">Follow</button>
						</div>
					</div>
			...
			<footer>
				<nav>
					<span>Turko Shakhidov</span>
					<span>Ruben Ribeiro</span>
					<span>Rayane Bertal</span>
					<span>Lebron James</span>
					<span>Mohammed Salag</span>
					<span>Fucklee <svg viewBox="0 0 24 24" aria-hidden="true">
							<g>
								<circle cx="5" cy="12" r="2"></circle>
								<circle cx="12" cy="12" r="2"></circle>
								<circle cx="19" cy="12" r="2"></circle>
